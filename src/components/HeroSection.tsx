          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="flex -space-x-2">
                {['bg-blue-400', 'bg-violet-400', 'bg-emerald-400', 'bg-amber-400'].map((color, i) => (
...
function HeroIllustration() {
  const skills = [
    { label: 'Programación', color: 'from-blue-500 to-blue-600', icon: '💻', top: '10%', left: '5%' as const },
    { label: 'Diseño Gráfico', color: 'from-violet-500 to-violet-600', icon: '🎨', top: '10%', right: '5%' as const },
    { label: 'Marketing', color: 'from-emerald-500 to-emerald-600', icon: '📈', bottom: '10%', left: '5%' as const },
    { label: 'Inglés', color: 'from-amber-500 to-amber-600', icon: '🌐', bottom: '10%', right: '5%' as const },
  ]
  ...
  return (
    <div className="relative w-115 h-115">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 p-6 w-48 text-center space-y-3 hover:shadow-blue-100 transition-shadow duration-500">
      ...
      {/* Skill pills floating around */}
      {skills.map((skill) => (
        <div
          key={skill.label}
          className="absolute"
          style={{ top: skill.top, bottom: skill.bottom, left: skill.left, right: skill.right }}
        >
