      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-600 via-blue-700 to-violet-700 px-8 py-16 sm:px-16 sm:py-20 text-center shadow-2xl shadow-blue-300">
          ...
          <div className="absolute top-8 left-8 hidden sm:block">
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/80 text-xs font-medium backdrop-blur-sm">
              💻 Programación
            </span>
          </div>
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
              <a
                href="#"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold text-blue-700 bg-white hover:bg-blue-50 shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
              >
                Únete a SkillSwap
              ...
              <a
                href="#como-funciona"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold text-white/90 bg-white/10 border border-white/20 hover:bg-white/20 backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5"
              >
                Ver cómo funciona
              </a>
            </div>
            ...
            <p className="text-blue-200 text-sm">
              Sin tarjeta de crédito · Sin compromisos · Gratis para siempre
            </p>
          </div>
        </div>
      </div>
